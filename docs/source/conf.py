# -*- coding: utf-8 -*-
#
# datalad_wackyextra documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_wackyextra:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_wackyextra.__version__
release = version
